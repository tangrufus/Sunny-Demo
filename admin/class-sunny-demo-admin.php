...
class Sunny_Demo_Admin {
	...
	private function __construct() {
		 ...
		 * @TODO:
		 *
		 * - Rename "Sunny_Demo" to the name of your initial plugin class
		 *
		 */
	 ...
	 * @TODO:
	 *
	 * - Rename "Sunny_Demo" to the name your plugin
	 *
	 * @since     1.0.0
	 *
	...
	public function enqueue_admin_styles() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_style( $this->plugin_slug .'-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), Sunny_Demo::VERSION );
		}
	...
	public function enqueue_admin_scripts() {
		...
		$screen = get_current_screen();
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'assets/js/admin.js', __FILE__ ), array( 'jquery' ), Sunny_Demo::VERSION );
		}
